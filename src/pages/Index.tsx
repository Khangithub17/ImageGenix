    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <header className="p-6 bg-white bg-opacity-70 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold font-montserrat bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent transition-all duration-300 hover:scale-105 tracking-tight">
            ImageGenix
          </h1>
          <p className="text-lg md:text-xl mt-2 font-montserrat text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-gray-800 font-medium italic flex items-center justify-center gap-2">
